...
//create a class name StudentGradeCalculator2DArray used to display the grade of student based on marks.
public class StudentGradeCalculator2DArray 
{
    ...
    public static void main(String[] args) 
	{
        ...
        // Create 2D array to store marks for Physics, Chemistry, and Maths
